...
[macro name="startoption"]
	...
	;システムボタン
	[button name="role_button" role="skip" graphic="button/skip.png" enterimg="button/skip2.png" x="390" y="680"]
	[button name="role_button" role="save" graphic="button/save.png" enterimg="button/save2.png" x="480" y="680"]
	[button name="role_button" role="load" graphic="button/load.png" enterimg="button/load2.png" x="570" y="680"]
	[button name="role_button" role="auto" graphic="button/auto.png" enterimg="button/auto2.png" x="660" y="680"]
	[button name="role_button" role="title" graphic="button/title.png" enterimg="button/title2.png" x="750" y="680"]
	[button name="role_button" role="menu" graphic="button/menu.png" enterimg="button/menu2.png" x="840" y="680"]
	[button name="role_button" role="fullscreen" graphic="button/screen.png" enterimg="button/screen2.png" x="930" y="680"]
